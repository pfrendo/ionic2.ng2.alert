...
module.exports = function (config) {
	config.set({
		...
		systemjs: {
			...
			config: {
				paths: {
					...
					"jasmine-jquery": "bower_components/jasmine-jquery/lib/jasmine-jquery.js",
		...
		proxies: {
			...
			"/base/_artifact/amd/assets/": "/base/_artifact/assets/",
		...
		files: [
			...
			`${conf.test.output}/*.spec.js`,
			{
				pattern: `${conf.artifact.root}/**/*.js.map`,
				included: false
			}],
